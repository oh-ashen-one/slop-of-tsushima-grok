...
import {
  makeRock, makeDeadTree, makeLog, makeStump,
  makeBush, makeBamboo, makePineTrunk, makePineCrown,
  makeStoneMarker, makeStoneSlab,
} from './scatter/Geometry.js';
import { makeBushAtlas } from './scatter/Textures.js';
import { makeScatterMaterial, updateScatterMaterial } from './scatter/Material.js';
import {
  Probe, clusterMask, findBridgeSite,
} from './scatter/Placement.js';
import { Bedding } from './scatter/Bedding.js';
import { ScatterCollision } from './scatter/Collision.js';
import { planHeroes, emitHeroFormation, emitBridge } from './scatter/Heroes.js';
 ...
 *
 *   rock       boulders, mossy stones, bedded slabs, small outcrops
 *   wood       fallen logs, stumps, driftwood, bamboo-like canes
 *   plants     maple saplings / mossy thickets (retinted bush cards)
 *   heroes     lone pine, boulder cluster, stone marker, creek bridge
 *
...
/* Cooler grey stone and warm gold lichen — not oxidised red desert. */
const ROCK_TINTS = [
  [0.90, 0.92, 0.96], // cool grey
  [0.86, 0.88, 0.92], // slate
  [0.96, 0.94, 0.88], // warm stone
  [0.92, 0.93, 0.90], // lichen grey
  [1.00, 0.94, 0.78], // gold-lichen wash
];

const FOLIAGE_TINTS = [
  [1.08, 0.48, 0.24], // maple autumn
  [0.58, 0.76, 0.32], // maple green
  [0.90, 0.72, 0.30], // gold-green
  [0.68, 0.74, 0.40], // moss
];
