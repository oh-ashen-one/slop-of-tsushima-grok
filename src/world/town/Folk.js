...
function makeMan() {
  ...
  /* kasa — a conical straw hat, not a cowboy brim. */
  f.limb([0, 1.68, 0], [0, 1.80, 0], 0.30, 0.045, 10, P.body, hip, Z.hat,
    [0.90, 0.86, 0.72], { rings: 2, cap: true, shade: 0.16 });
  return f;
}
...
function makeWoman() {
  ...
  /* kasa, same silhouette as the men so nobody reads as a pioneer bonnet */
  f.limb([0, 1.62, 0], [0, 1.74, 0], 0.28, 0.042, 10, P.body, hip, Z.hat,
    [0.90, 0.86, 0.72], { rings: 2, cap: true, shade: 0.16 });
  return f;
}
...
/**
 * Visitor palette: indigo, walnut, charcoal, faded hemp. Straw kasa sits
 * warmer than the robes. Nothing saturated — these figures are dark notes
 * against gold gravel, not costumes.
 */
const COATS = [
  [0.048, 0.052, 0.070], [0.070, 0.056, 0.042], [0.036, 0.036, 0.040],
  [0.090, 0.072, 0.052], [0.055, 0.048, 0.042], [0.062, 0.070, 0.058],
];
const TROUS = [
  [0.050, 0.046, 0.040], [0.040, 0.042, 0.050], [0.072, 0.060, 0.046],
  [0.058, 0.052, 0.044],
];
const HATS = [
  [0.160, 0.140, 0.095], [0.125, 0.112, 0.078], [0.180, 0.158, 0.110],
  [0.100, 0.090, 0.065],
];
const DRESS = [
  [0.080, 0.070, 0.058], [0.048, 0.050, 0.062], [0.100, 0.086, 0.068],
  [0.062, 0.048, 0.044], [0.090, 0.082, 0.070],
];
