...
export class Water {
  ...
  constructor(ctx) {
    ...
    this.tuning = {
      /** Per-metre extinction. A clear Japanese creek: gold in the shallows from
       *  the sky, dark tea-green in the channel, not silty western chocolate. */
      absorb: new THREE.Vector3(0.92, 0.62, 0.78),
      ...
      scatter: new THREE.Vector3(0.055, 0.078, 0.062),
      refraction: 0.115,
      foam: 1.0,
      caustics: 1.0,
      specular: 1.0,
